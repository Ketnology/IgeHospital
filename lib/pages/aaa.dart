...
class AAAPage extends StatefulWidget {
  const AAAPage({super.key});

  @override
  State<AAAPage> createState() => _AAAPage();
}

class _AAAPage extends State<AAAPage> {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildComp5(count: 2)),
                      ],
                    ),
                    _buildcompo6formobile(),
                    const MySizeBox(),
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildComp5(count: 4)),
                      ],
                    ),
                    _buildcompo6(),
                    const MySizeBox(),
  ...
  Widget _buildComp5({required int count}) {
